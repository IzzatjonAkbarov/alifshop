  ...
  return (
    <div className="flex items-center justify-center flex-col h-[60vh]">
      <div className="grid gap-4 w-60">
        ...
        <div>
          <h2 className="text-center text-gray-800 text-base font-semibold leading-relaxed pb-1">
          ...
          <div className="flex gap-3">
            <button
              onClick={() => navigate("/")}
              className="w-full px-3 py-2 bg-[#FFBE1E] hover:bg-[#FFBE1E] transition-all duration-500 rounded-full text-white text-xs font-semibold leading-4">
              Go to the Home page
            </button>
          </div>
        </div>
