  ...
  return (
    <>
      <nav className="container1 flex items-center justify-between py-3">
        ...
        <div className=" gap-2 w-[30%] border-2 border-[#FFBE1E] flex items-center  rounded-lg justify-between">
        ...
        <div className="text-[18px] font-medium  gap-1 flex items-center ">
          <p>РУС</p> / <p>UZB</p>
        </div>
      </nav>
    </>
